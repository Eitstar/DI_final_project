...
<div id='trail'> 
 <h3 className="headTextIndex"> Begin Your Journey into the History of the Israeli Cuisine....</h3>
</div> 
...
className='btns' 
buttonStyle='btn--outline' 
buttonSize='btn--large'> registered? Login here  <i className='far fa-play-circle' />
</Button>
</Link>
</div> 
